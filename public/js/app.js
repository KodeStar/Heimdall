...
if (clock.length) {
  var setDate = function setDate() {
    ...
    $('.date', clock).html("<span>".concat(date.toLocaleDateString(undefined, formatDay), "</span>").concat(date.toLocaleDateString(undefined, formatDate)));
    $('.time', clock).html("".concat(date.toLocaleTimeString(undefined, formatHour), "<span class=\"blink\">:</span>").concat(date.toLocaleTimeString(undefined, formatMinute)));
  };
